...
function modal(modal, btn, span) {
  const btnElement = document.querySelector(btn);
  const spanElement = document.querySelector(span);
  btnElement.addEventListener("click", () => (modal.style.display = "block"));
  spanElement.addEventListener("click", () => (modal.style.display = "none"));
